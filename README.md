# Star Tribune - Minnesota Poll 2018: Franken resignation survey
...
1. Get code and enter project: `git clone https://github.com/striblab/20180116-franken.git && cd 20180116-franken.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180116-franken/ && rsync -rav ./ ../20180116-franken/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
